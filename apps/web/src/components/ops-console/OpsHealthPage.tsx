  ...
  const executionSignals: HealthDecisionSignal[] = [
    {
      ...
      detail: (metrics?.queue_backlog.queued ?? 0) > 0 ? `Oldest queued ${oldestQueuedAge}` : "No queued or retryable work",
      href: "/ops/jobs",
      icon: "process",
    },
    {
    ...
    },
    {
      ...
      detail: `${metrics?.queue_backlog.running_with_lock ?? 0} locked · ${metrics?.queue_backlog.running_without_lock ?? 0} without lock`,
      href: "/ops/jobs?status=RUNNING",
      icon: "play",
    },
  ];
